...
def plot_q_values_map(qtable, env, map_size):
    ...
    # NEW: save the figure
    fig.savefig(f"results/q_values_map_{map_size}.png", bbox_inches="tight", dpi=200)
    plt.show()
    plt.close(fig)
...
def plot_states_actions_distribution(states, actions, map_size):
    ...
    # NEW: save the figure
    fig.savefig(f"results/states_actions_distribution_{map_size}.png", bbox_inches="tight", dpi=200)
    plt.show()
    plt.close(fig)
...
def plot_steps_and_rewards(rewards_df, steps_df):
    ...
    # NEW: save the figure
    fig.savefig("results/steps_and_rewards.png", bbox_inches="tight", dpi=200)
    plt.show()
    plt.close(fig)
